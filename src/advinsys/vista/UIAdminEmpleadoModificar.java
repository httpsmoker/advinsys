 ...
 * @author PC
 */
public class UIAdminEmpleadoModificar extends javax.swing.JDialog {

    private EmpleadoDAO empleadoDAO;
    private static String nombre, apellido, direccion, fechaN, fechaI, funcion, contra;
    private static double telefono;

    public UIAdminEmpleadoModificar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void agregarEmpleados() {
        try {
            ...
            if (txtNombre.getText().equals("") || txtApellido.getText().equals("") || txtDireccion.getText().equals("") || dateNac.getDate() == null || dateIn.getDate() == null || txtTelefono.getText().equals("") || cbFuncion.getSelectedIndex()==0|| txtContra.getText().equals("")) {
    ...
    public void cargarEmpleados() {
        try {
            ...
            int i = UIEmpleados.getDato2();
            txtId.setText(listaEmpleados.get(i).getIdEmpleado());
            txtNombre.setText(listaEmpleados.get(i).getNombreEmpleado());
            txtNombre.setForeground(Color.red);
            txtApellido.setText(listaEmpleados.get(i).getApellidos());
            ...
            fechaDate = formato.parse(listaEmpleados.get(i).getFechaNac());
            fechaDate2 = formato.parse(listaEmpleados.get(i).getFechaIngreso());
            dateNac.setDate(fechaDate);
            dateNac.setForeground(Color.red);
            dateIn.setDate(fechaDate2);
            dateIn.setForeground(Color.red);
            txtTelefono.setText(String.valueOf(listaEmpleados.get(i).getTelefono()));
            txtTelefono.setForeground(Color.red);
            cbFuncion.setSelectedItem(listaEmpleados.get(i).getFuncion());
            cbFuncion.setForeground(Color.red);
            txtContra.setText(listaEmpleados.get(i).getPassword());
                        ...
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addGap(60, 60, 60)
                                    .addComponent(dateNac, javax.swing.GroupLayout.PREFERRED_SIZE, 372, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createSequentialGroup()
                                    ...
                                    .addGap(60, 60, 60)
                                    .addComponent(dateIn, javax.swing.GroupLayout.PREFERRED_SIZE, 372, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(layout.createSequentialGroup()
                                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UIAdminEmpleadoModificar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UIAdminEmpleadoModificar dialog = new UIAdminEmpleadoModificar(new javax.swing.JFrame(), true);
