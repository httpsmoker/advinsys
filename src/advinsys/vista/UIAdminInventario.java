 ...
 * @author PC
 */
public class UIAdminInventario extends javax.swing.JDialog {
    ...
    public UIAdminInventario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void txtCantidadKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCantidadKeyTyped
        ...
        String txt = txtCantidad.getText();
    ...
    private void txtIdProductoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtIdProductoKeyTyped
        String t = txtIdProducto.getText();
    ...
    private void txtDescripcionKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtDescripcionKeyTyped
        String x = txtDescripcion.getText();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UIAdminInventario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UIAdminInventario dialog = new UIAdminInventario(new javax.swing.JFrame(), true);
