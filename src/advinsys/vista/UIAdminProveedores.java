 ...
 * @author PC
 */
public class UIAdminProveedores extends javax.swing.JDialog {

    private ProveedorDAO proveedorDAO;
    private static String idProveedor, nombreP, nit, direccion;
    private static double telefono;

    public UIAdminProveedores(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UIAdminProveedores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UIAdminProveedores dialog = new UIAdminProveedores(new javax.swing.JFrame(), true);
